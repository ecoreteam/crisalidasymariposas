...
if (!class_exists('Spring_Plant_Inc_Assets')) {
	class Spring_Plant_Inc_Assets {
		...
		public function registerAssets() {
			...
			// smooth-scroll
			wp_register_script('smooth-scroll',Spring_Plant()->helper()->getAssetUrl('assets/vendors/smoothscroll/SmoothScroll.min.js'),array('jquery'),'1.4.4',true);
		...
		public function enqueueAssets() {
			...
			// smooth scroll
			$smooth_scroll = Spring_Plant()->options()->get_smooth_scroll();
			if ($smooth_scroll === 'on') {
		...
		public function enqueueSubMenuAssets() {
			...
			Spring_Plant()->helper()->getSkinClass($sub_menu_skin);
		}
