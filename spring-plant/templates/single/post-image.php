...
if (has_post_format('gallery')): ?>
    <?php $gallery_images = get_post_meta($post_id, Spring_Plant_Post_Formats_UI()->get_format_gallery_images(), true); ?>
...
<?php elseif (has_post_format('video')): ?>
    <?php $video_embed = get_post_meta($post_id, Spring_Plant_Post_Formats_UI()->get_format_video_embed(), true); ?>
    <?php if ($video_embed !== ''): ?>
...
<?php elseif (has_post_format('audio')): ?>
    <?php $audio_embed = get_post_meta($post_id, Spring_Plant_Post_Formats_UI()->get_format_audio_embed(), true); ?>
    <?php if ($audio_embed !== ''): ?>
        <?php $hasThumb = true; ?>
