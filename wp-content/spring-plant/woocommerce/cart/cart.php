...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <?php if ( wc_coupons_enabled() ) { ?>
        <div class="coupon">
            <h4 class="woocommerce-block-title"><?php esc_html_e( 'Counpon discount', 'spring-plant' ); ?></h4>
            <p class="coupon-desc"><?php esc_html_e( 'Enter your code if you have one. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae', 'spring-plant' ); ?></p>
