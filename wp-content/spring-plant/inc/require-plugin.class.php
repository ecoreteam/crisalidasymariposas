         ...
         */
            $plugins = array(
                array(
                    ...
                    'source'             => get_template_directory() . '/inc/plugins/spring-framework-v1.7.zip', // The plugin source
                ...
                array(
                    ...
                    'source'             => get_template_directory() . '/inc/plugins/revslider_5.4.8.zip', // The plugin source
                    'required'           => true, // If false, the plugin is only 'recommended' instead of required
                ...
                array(
                    ...
                    'source'             => get_template_directory() . '/inc/plugins/js_composer_5.5.2.zip', // The plugin source
                    'required'           => true, // If false, the plugin is only 'recommended' instead of required
                ...
                array(
                    'name' => esc_html__('WP Instagram Widget','spring-plant'),
